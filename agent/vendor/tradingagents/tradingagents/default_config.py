...
DEFAULT_CONFIG = _apply_env_overrides({
    ...
    # "low" | "medium" | "high" | "xhigh" | "max" — upstream's comment omits the
    # top two, and this deployment runs "high". None leaves the model at its own
    # default. An invalid value is rejected by ChatAnthropic at construction
    # (pydantic Literal), so a typo fails the run loudly rather than silently
    # dropping back to default — which is what this path wants.
