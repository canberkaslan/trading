...
MODEL_OPTIONS: ProviderModeOptions = {
    ...
    "anthropic": {
        ...
        "deep": [
            # Fork delta: claude-opus-5 is what this deployment runs as its deep
            # model and upstream's list does not carry it, so an unpatched resync
            # brings back the "not in the known model list ... Continuing anyway"
            # RuntimeWarning on every graph construction.
            ("Claude Opus 5 - Current frontier, long-running agents and coding", "claude-opus-5"),
